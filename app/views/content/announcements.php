...
$username = $row['username'];
	...
	<article class="announcement">
		...
		<a class="a-alt" href="<?php echo "$sub_path/content/activity_by_date/"; ?><?php echo (new DateTime($row['date_created']))->format('Y-m-d');?>" aria-label="View activity for <?php echo (new DateTime($thread['date_created']))->format('l F d, Y'); ?>"><?php echo $row['date_created'];?></a>
		<?php if(!empty($user['admin']) && $user['admin']) { ?>
